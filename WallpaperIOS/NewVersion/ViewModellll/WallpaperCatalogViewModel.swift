...
class WallpaperCatalogViewModel: ObservableObject {
    ...
    func getAllTags()  {
        ...
        guard let url  = URL(string: "\(domain)api/v1/special-contents-v2?order_by=order+asc,type+desc&with=tags+id,title,active\(AppConfig.forOnlyIOS)") else {
            return
        }
    ...
    @Published var shufflePackNew : [SpWallpaper] = []
     func getshufflePackNew() {
        
         let urlString = "\(domain)api/v1/image-specials?limit=7\(getSortParamStr(sort: .NEW))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+1\(AppConfig.forOnlyIOS)"
            ...
            URLSession.shared.dataTask(with: url){
                ...
                DispatchQueue.main.async {
                    self.shufflePackNew = itemsCurrentLoad?.data.data  ?? []
    ...
    @Published var shufflePackPopular : [SpWallpaper] = []
     func getshufflePackPopular() {
        
         let urlString = "\(domain)api/v1/image-specials?limit=7\(getSortParamStr(sort: .POPULAR))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+1\(AppConfig.forOnlyIOS)"
            ...
            URLSession.shared.dataTask(with: url){
                ...
                DispatchQueue.main.async {
                    self.shufflePackPopular = itemsCurrentLoad?.data.data  ?? []
    ...
    @Published var depthEffectNew : [SpWallpaper] = []
     func getDepthEffectNew() {
        
         let urlString = "\(domain)api/v1/image-specials?limit=7\(getSortParamStr(sort: .NEW))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+2\(AppConfig.forOnlyIOS)"
            ...
            URLSession.shared.dataTask(with: url){
                ...
                DispatchQueue.main.async {
                    self.depthEffectNew = itemsCurrentLoad?.data.data  ?? []
    ...
    @Published var depthEffectPopular : [SpWallpaper] = []
     func getDepthEffectPopular() {
        
         let urlString = "\(domain)api/v1/image-specials?limit=7\(getSortParamStr(sort: .POPULAR))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+2\(AppConfig.forOnlyIOS)"
            ...
            URLSession.shared.dataTask(with: url){
                ...
                DispatchQueue.main.async {
                    self.depthEffectPopular = itemsCurrentLoad?.data.data  ?? []
    ...
    @Published var dynamicNew : [SpWallpaper] = []
     func getDynamicNew() {
        
         let urlString = "\(domain)api/v1/image-specials?limit=7\(getSortParamStr(sort: .NEW))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+3\(AppConfig.forOnlyIOS)"
            ...
            URLSession.shared.dataTask(with: url){
                ...
                DispatchQueue.main.async {
                    self.dynamicNew = itemsCurrentLoad?.data.data  ?? []
    ...
    @Published var dynamicPopular : [SpWallpaper] = []
     func getDynamicPopular() {
        
         let urlString = "\(domain)api/v1/image-specials?limit=7\(getSortParamStr(sort: .POPULAR))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+3\(AppConfig.forOnlyIOS)"
            ...
            URLSession.shared.dataTask(with: url){
                ...
                DispatchQueue.main.async {
                    self.dynamicPopular = itemsCurrentLoad?.data.data  ?? []
