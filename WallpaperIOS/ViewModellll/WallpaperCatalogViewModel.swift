...
//        
//         let urlString = "\(domain)api/v1/image-specials?limit=15\(getSortParamStr(sort: .NEW))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+1\(AppConfig.forOnlyIOS)"
//            
//            guard let url  = URL(string: urlString) else {
//                return
//            }
...
//        
//         let urlString = "\(domain)api/v1/image-specials?limit=15\(getSortParamStr(sort: .NEW))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+2\(AppConfig.forOnlyIOS)"
//            
//            guard let url  = URL(string: urlString) else {
//                return
//            }
...
//     func getDynamicNew() {
//        
//         let urlString = "\(domain)api/v1/image-specials?limit=15\(getSortParamStr(sort: .NEW))&offset=0&with=special_content+type,id,title&where=special_content_v2_id+3\(AppConfig.forOnlyIOS)"
//            
//            guard let url  = URL(string: urlString) else {
//                return
//            }
